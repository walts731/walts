...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2023 at 10:38 AM
...
INSERT INTO `orders` (`order_id`, `user_id`, `p_id`, `amount`, `date_ordered`, `order_status`, `order_qty`, `payment_id`, `address_id`) VALUES
(1, 2, 1, 100.00, '2023-10-21', 'pending', 2, 1, 2),
(2, 2, 1, 150.00, '2023-10-21', 'shipped', 3, 2, 2);
